package com.valuequo.web.rest;

import com.valuequo.config.Constants;
import com.valuequo.AmfiApp;
...
import com.valuequo.web.rest.errors.ExceptionTranslator;
import com.valuequo.web.rest.vm.KeyAndPasswordVM;
import com.valuequo.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = AmfiApp.class)
